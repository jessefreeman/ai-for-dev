...
Fully open-source agentic AI IDE shipped as a *full editor* (not a VS Code extension). Repository: [github.com/voideditor/void](https://github.com/voideditor/void). Direct competitor to [[cursor]] and Windsurf, distinguished by its **two agent modes**.
...
- [[summary-worldofai-void-ide|Void IDE update walkthrough]]

## See Also

- [[cline]], [[continue]] — sibling extension-based free stack
- [[opencode]] — terminal-native sibling
- [[cursor]] — primary commercial target
